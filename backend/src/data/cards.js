...
export const categoryDefinitions = {
  ...
  amor: {
    id: "amor",
    pt: { label: "❤️ Amor", title: "❤️ AMOR" },
    es: { label: "❤️ Amor", title: "❤️ AMOR" },
    en: { label: "❤️ Love", title: "❤️ LOVE" },
  },
  paz: {
    id: "paz",
    pt: { label: "🕊️ Paz", title: "🕊️ PAZ" },
    es: { label: "🕊️ Paz", title: "🕊️ PAZ" },
    en: { label: "🕊️ Peace", title: "🕊️ PEACE" },
  },
  familia: {
    id: "familia",
